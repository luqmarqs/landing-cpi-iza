function Footer({ logo, text, instagram, instagramLabel, onOpenPrivacy, backgroundColor }) {
  return (
    <footer className="site-footer" style={{ backgroundColor }}>
      <div className="container footer-content">
        <img src={logo} alt="Logo da organizacao" />
        <p>{text}</p>
        <a href={instagram} target="_blank" rel="noreferrer" className="footer-instagram">
        ...
        <button type="button" className="footer-link" onClick={onOpenPrivacy}>
